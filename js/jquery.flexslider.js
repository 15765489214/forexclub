            ...
            controlNav: {
                ...
                setupPaging: function() {
                    ...
                    if (a.controlNavScaffold = e('<ol class="' + o + "control-nav " + o + n + '"></ol>'), a.pagingCount > 1)
                        for (var c = 0; c < a.pagingCount; c++) t = "thumbnails" === i.controlNav ? '<img src="' + a.slides.eq(c).attr("data-thumb") + '"/>' : '<a><i class="icon-circle-blank"></i></a>', a.controlNavScaffold.append("<li>" + t + "</li>"), l++;
